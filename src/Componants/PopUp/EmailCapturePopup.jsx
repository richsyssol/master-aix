...
//           from_email: values.email,
//           message:
//             "New lead downloaded the guide: 5 Automation Hacks to Double Your Leads",
//         },
//         "YOUR_USER_ID" // Replace with your EmailJS user ID
//       );

//       // Alternatively, you can send to your backend API
//       // await axios.post('/api/store-email', { email: values.email });

//       message.success("Guide sent to your email!");
//       form.resetFields();
//       onClose();
//     } catch (error) {
//       console.error("Error sending email:", error);
//       message.error("Failed to send guide. Please try again.");
//     } finally {
//       setLoading(false);
//     }
//   };
